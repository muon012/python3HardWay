...
for question in questions:
	print(question[0], " is ... ", end="")
	user_answer = input().title()  # .title() capitalizes the first letter but it's best for single/simple words.
	if user_answer == str(question[1]):
		print("Correct")
	else:
		print("Incorrect. It is ----> {}".format(question[1]))
